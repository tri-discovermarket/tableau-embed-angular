...
router.get('/', (req, res) => {
    ...
    let payload = {
        ...
        'scp': ['tableau:views:embed', 'tableau:metrics:embed', 'tableau:views:embed_authoring', 'tableau:insights:embed', 'tableau:ask_data:embed', 'tableau:metrics:embed']    //    Scopes
    }
    let options = {
      'header':{
        'typ': 'JWT',
    ...
    console.log(`The secret value is ${tableauConnectedAppSecretValue}`);
